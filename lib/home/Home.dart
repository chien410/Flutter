        ...
        builder:(context, snapshot) {
          ...
          return
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Icon(Icons.map),
                      SizedBox(width: 20,),
                      Text('台北市松山區光復北路巷11巷33號', style: TextStyle(fontSize: 18,),),
                    ],
                  ),
            ...
            return InkWell(
                  ...
                  Container(
                      child: Row(
                        children: [
                          SizedBox(width: 20,),
                          Icon(Icons.whatshot),
                          Text('${news.data.result[index].newsFirstTitle}',
              ...
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => NewsDetail(passData)));
              }
            );
          },
